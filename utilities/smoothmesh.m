function [p,t] = smoothmesh(p,t,constr,maxit,tol)
...
%                                              n21,n22,n23; etc].
%  constr: Nx1 array of vertex IDs of points that you want to constrain.
...
%  EXAMPLE:
%
%  [p,t] = smoothmesh(p,t,constr,10,0.05);
%
% Darren Engwirda - 2007.
%   modified by Keith Roberts, 2017
