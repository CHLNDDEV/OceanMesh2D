classdef meshgen
    ...
    methods
        ...
        function  obj = build(obj)
            ...
            edgefx_opts = {}; 
            for i = 1 : length(obj.ef)
                edgefx_opts{end+1} = {'iterations_performed',it,...
                    'clean_up',obj.cleanup,...
                    'npfix',length(obj.pfix),...
                    'negfix',length(obj.egfix),...
                    'dis',reshape(obj.ef{i}.dis.',1,[]),...
                    'fs',reshape(obj.ef{i}.fs.',1,[]),...
                    'wl',reshape(obj.ef{i}.wl.',1,[]),...
                    'slp',reshape(obj.ef{i}.slp.',1,[]),...
                    'fl',reshape(obj.ef{i}.fl.',1,[]),...
                    'ch',reshape(obj.ef{i}.ch.',1,[]),...
                    'AngOfRe',obj.ef{i}.AngOfRe,...
                    'grade',reshape(obj.ef{i}.g.',1,[]),... 
                    'dt',obj.ef{i}.dt,...
                    'edgefx_gridspace',obj.ef{i}.gridspace,...
                    'max_el',reshape(obj.ef{i}.max_el.',1,[]),...
                    'max_el_ns',reshape(obj.ef{i}.max_el_ns.',1,[]),...
                    'min_el_ch',reshape(obj.ef{i}.min_el_ch.',1,[]),...
                    'channels',obj.ef{i}.Channels
                    };
                % log the edgefx options used
                obj.grd = obj.grd.logger(['mesh generation using inset #', num2str(i)],edgefx_opts{i});
            end
